...
contract HubRewards is ERC20Permit, Ownable {
    ...
    constructor() ERC20("HubRewards", "HUBR", 9) ERC20Permit() {
    ...
    /**
        @notice increases sEVER supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sEVER
